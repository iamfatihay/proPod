...
describe("RecommendationsService", () => {
    ...
    describe("getPersonalizedRecommendations", () => {
        ...
        it("should filter out non-AI-enhanced podcasts", async () => {
            ...
            const recommendations =
                await RecommendationsService.getPersonalizedRecommendations(10);
    ...
    describe("getSimilarPodcasts", () => {
        it("should return empty array when reference podcast not found", async () => {
            ...
            const similar = await RecommendationsService.getSimilarPodcasts(
                999,
                5
            );
        ...
        it("should calculate similarity scores", async () => {
            ...
            expect(similar[0].similarity).toBeGreaterThan(
                similar[similar.length - 1].similarity
            );
        });
    });
