...
export default function NotificationsScreen() {
    ...
    const handleNotificationPress = (notification) => {
        ...
        // dm ÃÂ¢ÃÂÃÂ open the conversation (actor_id is the sender); fall back to inbox
        if (notification.type === 'dm') {
            const partnerId = notification.actor_id;
            if (partnerId) {
                // Coerce to string ÃÂ¢ÃÂÃÂ chat-details expects a string route param
        ...
        // new_episode ÃÂ¢ÃÂÃÂ open the episode detail; podcast id lives in action.params
