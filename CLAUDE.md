...
See `docs/architecture/AI_PROVIDER_ARCHITECTURE.md` for details.
...
- **AI Integration**: `docs/features/AI_INTEGRATION_GUIDE.md`
- **Testing Guide**: `docs/testing/TEST_DOCUMENTATION.md`
- **All Docs**: `docs/README.md` - comprehensive navigation hub
...
### Resources
- Implementation: `docs/project/RTC_SESSION_MEMORY.md`
- Research: `docs/project/VIDEO_PODCAST_RESEARCH.md`
