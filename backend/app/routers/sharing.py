...
async def share_podcast_web(
    ...
    <head>
        ...
        <meta property="og:image" content="{podcast.cover_image_url or 'https://volo.app/og-image.png'}">
        ...
        <meta name="twitter:image" content="{podcast.cover_image_url or 'https://volo.app/og-image.png'}">
    ...
    <body>
        <div class="player-container">
            ...
            <a href="volo://podcast/{podcast_id}" class="cta">
                🎧 Open in Volo App
            </a>
            <a href="https://volo.app/download" class="cta" style="background: #4a5568;">
                📱 Download Volo
            </a>
        </div>
    </body>
...
async def share_live_session_web(
    ...
    <head>
        ...
        {f'<meta http-equiv="refresh" content="0;url=volo://join/{invite_code}">' if session.is_live else ''}
    </head>
    <body>
        <div class="container">
            ...
            <a href="volo://join/{invite_code}" class="cta">
                🎙️ Join Live Session
            </a>
            <p style="color: #a0aec0; margin-top: 24px;">
                Don't have Volo? <a href="https://volo.app/download" style="color: #667eea;">Download now</a>
            </p>
        </div>
    </body>
    </html>
